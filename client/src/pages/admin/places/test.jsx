...
function Place() { 
    ...
    const columns = [                                //create places table 
    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                ...
                setloading(true)
                const data = (await axios.get("/api/places/getallplaces")).data    //get all the places
                setplaces(data.places)             //save all the data in setplaces
    ...
    async function deletePlace(_id) {
        try {
            const res = (await axios.patch('/api/places/deleteplace', { _id })).data;    //delete places
    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                ...
                setloading(true)
                const data = (await axios.get("/api/places/getallplaces")).data           //after delete get all places
                setplaces(data.places)
                setloading(false)
    ...
    return (                                                                //all the functions in the tab
